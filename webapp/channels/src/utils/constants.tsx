...
export const Preferences = {
    ...
    NOTIFY_ADMIN_REVOKE_DOWNGRADED_WORKSPACE:
...
export const ModalIdentifiers = {
    ...
    IP_FILTERING_DELETE_CONFIRMATION_MODAL:
        "ip_filtering_delete_confirmation_modal",
    IP_FILTERING_SAVE_CONFIRMATION_MODAL:
        "ip_filtering_save_confirmation_modal",
    ...
    CREATE_GROUP_SYNCABLES_MEMBERSHIP_MODAL:
        "create_group_syncables_membership_modal",
...
export const MattermostFeatures = {
    ...
    UPGRADE_DOWNGRADED_WORKSPACE:
        "mattermost.feature.upgrade_downgraded_workspace",
...
export const SocketEvents = {
    ...
    APPS_FRAMEWORK_PLUGIN_DISABLED:
...
defineMessages({
    ...
    licenseExpired: {
        ...
        defaultMessage:
            "{licenseSku} license is expired and some features may be disabled.",
    },
    licenseExpiring: {
...
export const CloudLinks = {
    ...
    PRORATED_PAYMENT:
        "https://mattermost.com/pl/mattermost-cloud-prorate-documentation",
    ...
    DELINQUENCY_DOCS:
        "https://docs.mattermost.com/about/cloud-subscriptions.html#failed-or-late-payments",
...
export const HostedCustomerLinks = {
    ...
    NEWSLETTER_UNSUBSCRIBE_LINK:
        "https://forms.mattermost.com/UnsubscribePage.html",
    PRIVACY: AboutLinks.PRIVACY_POLICY,
};

export const DocLinks = {
    ABOUT_TEAMS:
        "https://docs.mattermost.com/welcome/about-teams.html#team-url",
    ADVANCED_LOGGING: "https://mattermost.com/pl/advanced-logging",
    CONFIGURE_DOCUMENT_CONTENT_SEARCH:
        "https://mattermost.com/pl/configure-document-content-search",
    CONFIGURE_AD_LDAP_QUERY_TIMEOUT:
        "https://mattermost.com/pl/configure-ad-ldap-query-timeout",
    ...
    DEFAULT_LDAP_GROUP_SYNC:
        "https://mattermost.com/pl/default-ldap-group-sync",
    DESKTOP_MANAGED_RESOURCES:
        "https://mattermost.com/pl/desktop-managed-resources",
    ELASTICSEARCH: "https://mattermost.com/pl/setup-elasticsearch",
    ENABLE_CLIENT_SIDE_CERTIFICATION:
        "https://mattermost.com/pl/enable-client-side-certification",
    ...
    HIGH_AVAILABILITY_CLUSTER:
        "https://mattermost.com/pl/high-availability-cluster",
    ...
    ONBOARD_ADVANCED_PERMISSIONS:
        "https://mattermost.com/pl/advanced-permissions",
    ...
    SETUP_PERFORMANCE_MONITORING:
        "https://mattermost.com/pl/setup-performance-monitoring",
    SETUP_PUSH_NOTIFICATIONS:
        "https://mattermost.com/pl/setup-push-notifications",
    SETUP_SAML: "https://docs.mattermost.com/pl/setup-saml",
    SHARE_LINKS_TO_MESSAGES:
        "https://mattermost.com/pl/share-links-to-messages",
    ...
    TRUSTED_CONNECTION:
        "https://mattermost.com/pl/default-allow-untrusted-internal-connections",
...
export const DeveloperLinks = {
    ...
    SETUP_CUSTOM_SLASH_COMMANDS:
        "https://mattermost.com/pl/setup-custom-slash-commands",
    SETUP_INCOMING_WEBHOOKS:
        "https://mattermost.com/pl/setup-incoming-webhooks",
...
export const LicenseLinks = {
    ...
    EMBARGOED_COUNTRIES:
        "https://mattermost.com/pl/limitations-for-embargoed-countries",
    SOFTWARE_SERVICES_LICENSE_AGREEMENT:
        "https://mattermost.com/pl/software-and-services-license-agreement",
...
export const Constants = {
    ...
    ALL_MEMBERS_MENTIONS_REGEX:
        /(?:\B|\b_+)@(channel|all)(?!(\.|-|_)*[^\W_])/gi,
    ...
    HighlightedLanguages: {
        ...
        makefile: {
            name: "Makefile",
            extensions: ["mk", "mak"],
            aliases: ["make", "mf", "gnumake", "bsdmake", "mk"],
        },
        markdown: {
            name: "Markdown",
...
export const searchFilesHintOptions = [
    {
        searchTerm: "From:",
        message: defineMessage({
            id: "search_files_list_option.from",
            defaultMessage: "Files from a user",
        }),
    },
    {
        searchTerm: "In:",
        message: defineMessage({
            id: "search_files_list_option.in",
            defaultMessage: "Files in a channel",
        }),
    },
    {
        searchTerm: "On:",
        message: defineMessage({
            id: "search_files_list_option.on",
            defaultMessage: "Files on a date",
        }),
    },
    {
        searchTerm: "Before:",
        message: defineMessage({
            id: "search_files_list_option.before",
            defaultMessage: "Files before a date",
        }),
    },
    {
        searchTerm: "After:",
        message: defineMessage({
            id: "search_files_list_option.after",
            defaultMessage: "Files after a date",
        }),
    },
    {
        searchTerm: "Ext:",
        message: defineMessage({
            id: "search_files_list_option.ext",
            defaultMessage: "Files with a extension",
        }),
    },
    {
        searchTerm: "-",
        message: defineMessage({
            id: "search_files_list_option.exclude",
            defaultMessage: "Exclude search terms",
        }),
        additionalDisplay: "—",
    },
    {
        searchTerm: '""',
        message: defineMessage({
            id: "search_files_list_option.phrases",
            defaultMessage: "Files with phrases",
        }),
    },
];
