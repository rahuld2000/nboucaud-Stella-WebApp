...
const DraftsLink = makeAsyncComponent(
    "DraftsLink",
    lazy(() => import("components/drafts/drafts_link/drafts_link"))
);
...
const UnreadChannelIndicator = makeAsyncComponent(
    "UnreadChannelIndicator",
    lazy(() => import("../unread_channel_indicator"))
);
const UnreadChannels = makeAsyncComponent(
    "UnreadChannels",
    lazy(() => import("../unread_channels"))
);
...
export default class SidebarList extends React.PureComponent<Props, State> {
    ...
    navigateChannelShortcut = (e: KeyboardEvent) => {
        if (
            ...
            !e.ctrlKey &&
            !e.metaKey &&
            (isKeyPressed(e, Constants.KeyCodes.UP) ||
                isKeyPressed(e, Constants.KeyCodes.DOWN))
        ) {
            e.preventDefault();
            ...
            cmdOrCtrlPressed(e) &&
            e.shiftKey &&
            isKeyPressed(e, Constants.KeyCodes.K)
        ) {
